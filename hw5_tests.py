...
class TestCard(unittest.TestCase):
    ...
    def test_q1(self):
        ...
        # and allow you to check your answer with the autograder.  
    ...
    def test_q5(self):
        ...
        '''
        c1= hw5_cards.Deck()
        self.assertIsInstance(c1.deal_card(),hw5_cards.Card)
        return c1.deal_card(), hw5_cards.Card
    ...
    def test_q6(self):
        ...
        '''
        c1 = hw5_cards.Deck()
        c1_length = len(c1.cards)
        c1.deal_card()
        self.assertEqual(len(c1.cards),c1_length-1)
        return len(c1.cards), c1_length-1 
    ...
    def test_q7(self):
        ...
        (Please note that you want to use deal_card function first to 
        remove a card from the deck and then add the same card back in)
        ...
        c1.deal_card()
        c1_length = len(c1.cards)
        c1.replace_card(c1.deal_card)
        self.assertEqual(len(c1.cards), c1_length+1)
        return c1_length+1, len(c1.cards), c1_length+1
    
    def test_q8(self):
        '''
        1. fill in your test method for question 8:
        Test that if you invoke the replace_card method with a card 
        that is already in the deck, the deck size is not affected.
        (The function must silently ignore it if you try to add a card that’s 
        already in the deck)
        ...
        c1 = hw5_cards.Deck()
        c1_length = len(c1.cards)
        for item in c1.cards:
            c1.replace_card(item)
        self.assertEqual(len(c1.cards),c1_length)
        return len(c1.cards), c1_length  
